  ...
  if (adp_anglebc) then
    ...
    predbias_angord = zero
              ...
              do i=1,nchanl_diag
                 ...
                 call nc_diag_metadata("clw_index",                             sngl(cld_rbc_idx(ich_diag(i)))  )          ! cloud consistancy
                 call nc_diag_metadata("clw_index2",                            sngl(cld_rbc_idx2(ich_diag(i)))  )          ! cloud consistancy
